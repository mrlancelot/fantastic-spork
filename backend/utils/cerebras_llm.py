...
class CerebrasLLM(CustomLLM):
    ...
    def metadata(self) -> LLMMetadata:
        """Get LLM metadata."""
        return LLMMetadata(
            context_window=8192,  # Cerebras context window
    ...
    def _messages_to_cerebras_format(self, messages: Sequence[ChatMessage]) -> list:
        ...
        for message in messages:
            ...
            # Map LlamaIndex roles to Cerebras roles
            if role == MessageRole.SYSTEM.value:
                ...
                cerebras_role = "user"  # Default fallback
    ...
    def complete(
        ...
        try:
            # Convert prompt to chat format for Cerebras
...
# Convenience function to create a Cerebras LLM instance
